...
qap_instance<FieldT> mr1cs_to_qap_instance_map(const mr1cs_constraint_system<FieldT> &cs);

/**
 * Instance map for the R1CS-to-QAP reduction followed by evaluation of the resulting QAP instance.
 */
template<typename FieldT>
qap_instance_evaluation<FieldT> mr1cs_to_qap_instance_map_with_evaluation(const mr1cs_constraint_system<FieldT> &cs,
                                                                         const FieldT &t);
...
#include <libsnark/reductions/mr1cs_to_qap/mr1cs_to_qap.tcc>
