 ...
 */
template<typename ppT>
bool run_r1cs_oc_ppzksnark(const r1cs_example<libff::Fr<ppT> > &example,
                        const bool test_serialization)
{
    ...
    if (test_serialization)
    {
        ...
        keypair.pk = libff::reserialize<r1cs_conv_ppzksnark_proving_key<ppT> >(keypair.pk);
        keypair.vk = libff::reserialize<r1cs_conv_ppzksnark_verification_key<ppT> >(keypair.vk);
        pvk = libff::reserialize<r1cs_conv_ppzksnark_processed_verification_key<ppT> >(pvk);
    ...
    if (test_serialization)
    {
        ...
        proof = libff::reserialize<r1cs_conv_ppzksnark_proof<ppT> >(proof);
