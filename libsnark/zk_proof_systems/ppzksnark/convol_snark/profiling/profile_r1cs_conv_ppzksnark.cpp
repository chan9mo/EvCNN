...
#include <libsnark/common/default_types/r1cs_conv_ppzksnark_pp.hpp>
...
int main(int argc, const char * argv[])
{
    ...
    run_r1cs_conv_ppzksnark<default_r1cs_gg_ppzksnark_pp>(example, example, test_serialization);
