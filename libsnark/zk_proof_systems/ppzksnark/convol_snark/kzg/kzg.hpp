...
class commitkey
{
    ...
    libff::window_table<libff::G1<ppT> > g1table;
    ...
    g1(std::move(g1)),
    g2(std::move(g2)),
    g1table(std::move(g1table))
    {};

    size_t G1_size() const
    {
        return g1.size() + g1table.size();
    }
    ...
    {
       return (g1.size_in_bits() + g2.size_in_bits() + g1table.size_in_bits());
    }
...
#include <libsnark/zk_proof_systems/ppzksnark/convol_snark/kzg/kzg.tcc>
