...
#ifndef R1CS_CONV_PPZKSNARK_HPP_
#define R1CS_CONV_PPZKSNARK_HPP_
...
#include <libsnark/zk_proof_systems/ppzksnark/convol_snark/r1cs_conv_ppzksnark_params.hpp>
...
class r1cs_conv_ppzksnark_proving_key;
...
public:
    ...
    r1cs_conv_ppzksnark_constraint_system<ppT> constraint_system;

    r1cs_conv_ppzksnark_proving_key() {};
    r1cs_conv_ppzksnark_proving_key<ppT>& operator=(const r1cs_conv_ppzksnark_proving_key<ppT> &other) = default;
    r1cs_conv_ppzksnark_proving_key(const r1cs_conv_ppzksnark_proving_key<ppT> &other) = default;
    r1cs_conv_ppzksnark_proving_key(r1cs_conv_ppzksnark_proving_key<ppT> &&other) = default;
    r1cs_conv_ppzksnark_proving_key(libff::G1<ppT> &&alpha_g1,
                                  libff::G1<ppT> &&beta_g1,
                                  libff::G2<ppT> &&beta_g2,
                                  libff::G1<ppT> &&delta_g1,
                                  libff::G2<ppT> &&delta_g2,
    ...
    bool operator==(const r1cs_conv_ppzksnark_proving_key<ppT> &other) const;
    friend std::ostream& operator<< <ppT>(std::ostream &out, const r1cs_conv_ppzksnark_proving_key<ppT> &pk);
    friend std::istream& operator>> <ppT>(std::istream &in, r1cs_conv_ppzksnark_proving_key<ppT> &pk);
};
...
template<typename ppT>
class r1cs_conv_ppzksnark_verification_key;
...
public:
    ...
    r1cs_conv_ppzksnark_verification_key() = default;
    r1cs_conv_ppzksnark_verification_key(const libff::GT<ppT> &alpha_g1_beta_g2,
    ...
    bool operator==(const r1cs_conv_ppzksnark_verification_key<ppT> &other) const;
    friend std::ostream& operator<< <ppT>(std::ostream &out, const r1cs_conv_ppzksnark_verification_key<ppT> &vk);
    friend std::istream& operator>> <ppT>(std::istream &in, r1cs_conv_ppzksnark_verification_key<ppT> &vk);

    static r1cs_conv_ppzksnark_verification_key<ppT> dummy_verification_key(const size_t input_size);
};
...
template<typename ppT>
class r1cs_conv_ppzksnark_processed_verification_key;
...
public:
    ...
    bool operator==(const r1cs_conv_ppzksnark_processed_verification_key &other) const;
    friend std::ostream& operator<< <ppT>(std::ostream &out, const r1cs_conv_ppzksnark_processed_verification_key<ppT> &pvk);
    friend std::istream& operator>> <ppT>(std::istream &in, r1cs_conv_ppzksnark_processed_verification_key<ppT> &pvk);
};
 ...
 */
template<typename ppT>
class r1cs_conv_ppzksnark_keypair {
public:
    r1cs_conv_ppzksnark_proving_key<ppT> pk;
    r1cs_conv_ppzksnark_verification_key<ppT> vk;

    r1cs_conv_ppzksnark_keypair() = default;
    r1cs_conv_ppzksnark_keypair(const r1cs_conv_ppzksnark_keypair<ppT> &other) = default;
    r1cs_conv_ppzksnark_keypair(r1cs_conv_ppzksnark_proving_key<ppT> &&pk,
                              r1cs_conv_ppzksnark_verification_key<ppT> &&vk) :
        pk(std::move(pk)),
        vk(std::move(vk))
    {}

    r1cs_conv_ppzksnark_keypair(r1cs_conv_ppzksnark_keypair<ppT> &&other) = default;
};
...
template<typename ppT>
class r1cs_conv_ppzksnark_proof;
...
public:
    ...
    r1cs_conv_ppzksnark_proof(libff::G1<ppT> &&g_A,
                            libff::G2<ppT> &&g_B,
                            libff::G1<ppT> &&g_C) :
        g_A(std::move(g_A)),
        g_B(std::move(g_B)),
    ...
    bool operator==(const r1cs_conv_ppzksnark_proof<ppT> &other) const;
    friend std::ostream& operator<< <ppT>(std::ostream &out, const r1cs_conv_ppzksnark_proof<ppT> &proof);
    friend std::istream& operator>> <ppT>(std::istream &in, r1cs_conv_ppzksnark_proof<ppT> &proof);
};
 ...
 */
template<typename ppT>
r1cs_conv_ppzksnark_keypair<ppT> r1cs_conv_ppzksnark_generator(const r1cs_conv_ppzksnark_constraint_system<ppT> &cs);
...
bool r1cs_conv_ppzksnark_online_verifier_weak_IC(const r1cs_conv_ppzksnark_processed_verification_key<ppT> &pvk,
                                               const r1cs_conv_ppzksnark_primary_input<ppT> &input,
                                               const r1cs_conv_ppzksnark_proof<ppT> &proof);
...
/**
 * For debugging purposes (of r1cs_conv_ppzksnark_r1cs_conv_ppzksnark_verifier_gadget):
 *
 * A verifier algorithm for the R1CS GG-ppzkSNARK that:
...
#include <libsnark/zk_proof_systems/ppzksnark/convol_snark/r1cs_conv_ppzksnark.tcc>

#endif // r1cs_conv_PPZKSNARK_HPP_
